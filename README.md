...
on Linux; support for other desktop environments and OSes — Windows, macOS, other Linux
desktops — arrives as additional adapters, with no core changes (see
[docs/brief.md](docs/brief.md), design principle 6).
