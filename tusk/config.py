...
class Config:
    ...
    def from_env() -> "Config":
        return Config(
            ...
            gatekeeper_model=os.environ.get("GATEKEEPER_MODEL", "anthropic/claude-haiku-4-5"),
            main_agent_model=os.environ.get("MAIN_AGENT_MODEL", "anthropic/claude-sonnet-4-5"),
